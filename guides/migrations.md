...
4. [Audit log](./audit-log) — banks frequently land `@@audit` retroactively via a migration
5. [Soft delete](./soft-delete) — `deleted_at` columns are typically added by a follow-up migration on existing models
