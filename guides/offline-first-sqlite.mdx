...
```toml
[dependencies]
cratestack = { package = "cratestack-sqlite", version = "0.8", features = ["decimal-rust-decimal"] }
cratestack-macros = "0.8"
cratestack-rusqlite = "0.8"
```

The `0.8` requirements float across the whole `0.8.x` line rather than pinning a patch — every
