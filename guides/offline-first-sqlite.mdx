...
```toml
[dependencies]
cratestack = { package = "cratestack-sqlite", version = "0.7", features = ["decimal-rust-decimal"] }
cratestack-macros = "0.7"
cratestack-rusqlite = "0.7"
```

The `0.7` requirements float across the whole `0.7.x` line rather than pinning a patch — every
