...
```toml
[dependencies]
cratestack = { package = "cratestack-sqlite", version = "0.7.10", features = ["decimal-rust-decimal"] }
cratestack-macros = "0.7.10"
cratestack-rusqlite = "0.7.10"
```
...
The embedded backend is intentionally focused. The following are **not** implemented as of 0.7.1:
